...
The scripts aggregate the red/amber/green responses per sub-component and display them in individual bar charts. The components are used to group the individual charts. Two input templates are available: one for data that is available at the level of the individual reporter and one where this data has already been aggregated. 
...
3. An overview chart, displaying all individual charts grouped by component
